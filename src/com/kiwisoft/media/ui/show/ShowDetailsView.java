...
{
	private FrameTitleUpdater frameTitleUpdater;
	...
	private LookupField<ShowType> tfType;
	...
	protected void createContentPanel()
	{
		...
		imgLogo=new ImagePanel(new Dimension(130, 70));
		...
		tfType=new LookupField<ShowType>(new ShowTypeLookup());
		...
		add(new JLabel("Typ:"), new GridBagConstraints(0, row, 1, 1, 0.0, 0.0,
		        GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(10, 0, 0, 0), 0, 0));
		add(tfType, new GridBagConstraints(1, row, 4, 1, 1.0, 0.0,
		        GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(10, 5, 0, 0), 0, 0));

		row++;
		add(new JLabel("Originalsprache:"), new GridBagConstraints(0, row, 1, 1, 0.0, 0.0,
		        GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(10, 0, 0, 0), 0, 0));
		add(cbxLanguage, new GridBagConstraints(1, row, 4, 1, 1.0, 0.0,
		        GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(10, 5, 0, 0), 0, 0));
		...
		add(tfPrismaPattern, new GridBagConstraints(1, row, 4, 1, 1.0, 0.0,
		...
		add(new JLabel("TVTV:"), new GridBagConstraints(0, row, 1, 1, 0.0, 0.0,
		        GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 15, 0, 0), 0, 0));
		add(tfTVTVPattern, new GridBagConstraints(1, row, 4, 1, 1.0, 0.0,
		        GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(5, 5, 0, 0), 0, 0));
		...
		frameTitleUpdater=new FrameTitleUpdater();
