...
public class ShowsView extends ViewPanel
{
	...
	private class DoubleClickListener extends MouseAdapter
	{
		public void mouseClicked(MouseEvent e)
		{
			...
			if (e.isPopupTrigger() || e.getButton()==MouseEvent.BUTTON3)
			{
				...
				menuDownload.add(new DownloadPNWAction(wizard, shows));
	...
	private class ShowTableRow extends SortableTableRow<Show> implements PropertyChangeListener
	{
	...
	private class NewShowAction extends AbstractAction
	{
