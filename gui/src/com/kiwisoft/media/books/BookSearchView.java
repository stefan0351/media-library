...
public class BookSearchView extends SearchView<Book>
{
	...
	@Override
	protected SearchController<Book> createSearchController(TableController<Book> tableController)
	{
		return new SearchController<Book>(tableController)
		{
			@Override
			...
			@Override
			protected SortableTableRow<Book> createRow(Book book)
			{
				return new BookRow(book);
			}
		};
	}
