...
import com.kiwisoft.media.dataImport.TVTVInfoLoader;
...
public class DownloadTVTVDialog extends JDialog
{
	private DialogLookupField tfPath;
	private Set shows;

	public DownloadTVTVDialog(JFrame owner, Set shows) throws HeadlessException
	{
	...
	private class ApplyAction extends AbstractAction
	{
		...
		public void actionPerformed(ActionEvent e)
		{
			...
			{
				JOptionPane.showMessageDialog(DownloadTVTVDialog.this,
			...
			if (!path.exists())
			{
				int option=JOptionPane.showConfirmDialog(DownloadTVTVDialog.this,
			...
			dispose();
			new ProgressDialog((JFrame)getOwner(), new TVTVInfoLoader(pathName, shows)).show();
		}
	}
