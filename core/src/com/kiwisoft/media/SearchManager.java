...
public class SearchManager
{
	...
	public SearchPattern getSearchPattern(int type, Show show)
	{
		return DBLoader.getInstance().load(SearchPattern.class, null, "type=? and show_id=?", type, show.getId());
	}
	...
	public SearchPattern getSearchPattern(int type, Person person)
	{
		return DBLoader.getInstance().load(SearchPattern.class, null, "type=? and actor_id=?", type, person.getId());
	}
