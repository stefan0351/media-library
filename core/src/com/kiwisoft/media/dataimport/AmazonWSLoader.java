...
//	private static final String SECRET_ACCESS_KEY="h3XZzVMKNTbBnla4u/PbIs/zw2Xv0qrUEs8gkUTo";
    ...
    public AmazonWSLoader(String isbn)
    {
        this.isbn=isbn;
    }
            ...
            for (Item item : items.getItem())
            {
                ...
                if (item.getEditorialReviews()!=null)
                {
                    for (EditorialReview review : item.getEditorialReviews().getEditorialReview())
                    {
                        ...
                        {
                            String summary=trimLines(ImportUtils.toPreformattedText(review.getContent()));
                ...
                {
                    String detailPage=ImportUtils.loadUrl(item.getDetailPageURL());
    ...
    private String getDescription(String detailPage, String title)
    {
        ...
        if (matcher.find())
        {
            ...
            if (start>0)
            {
                ...
                description=trimLines(ImportUtils.toPreformattedText(description));
                return description;
            }
        }
        return null;
