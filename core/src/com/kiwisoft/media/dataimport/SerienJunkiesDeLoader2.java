 ...
 */
public class SerienJunkiesDeLoader2 implements EpisodeDataLoader2
{
	private final static Log log=LogFactory.getLog(SerienJunkiesDeLoader2.class);

//	private SimpleDateFormat airdateFormat;
	private String baseUrl;
	private Pattern keyPattern=Pattern.compile("(\\d+)x0*(\\d+)");

	public SerienJunkiesDeLoader2(String baseUrl)
	{
