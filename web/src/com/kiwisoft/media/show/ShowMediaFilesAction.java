 ...
 * @since 05.10.2009
 */
public class ShowMediaFilesAction extends ShowAction implements MediaFilesAction
{
	private Long typeId;
	...
	public String execute() throws Exception
	{
		...
		if (type!=null && getShow()!=null)
		{
			Set<MediaFile> files=MediaFileManager.getInstance().getMediaFiles(getShow(), type);
