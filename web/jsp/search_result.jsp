	...
	<media:content>
		<media:panel title="Search Result">
			...
			<p><b><%=shows!=null ? shows.size() : 0%> Show(s) found</b>
				...
				<ol>
				<%
					HTMLRenderer renderer=HTMLRendererManager.getInstance().getRenderer(Show.class);
			...
			<p><b><%=movies!=null ? movies.size() : 0%> Movie(s) found</b>
				...
				<ol>
				<%
					HTMLRenderer renderer=HTMLRendererManager.getInstance().getRenderer(Movie.class);
			...
			<p><b><%=persons!=null ? persons.size() : 0%> Person(s) found</b>
				...
				<ol>
				<%
					HTMLRenderer renderer=HTMLRendererManager.getInstance().getRenderer(Person.class);
