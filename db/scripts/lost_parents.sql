...
from mediafiles pi
	...
	left outer join seasons se on se.picture_id=pi.id
where ch.id is null and mo.id is null and pe.id is null and bo.id is null and sh.id is null and ca.id is null and se is null;
