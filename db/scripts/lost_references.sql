...
union select 'crew', id, 'person_id' from crew where person_id not in (select id from persons)
union select 'crew', id, 'episode_id' from crew where episode_id not in (select id from episodes)
union select 'crew', id, 'movie_id' from crew where movie_id not in (select id from movies)
...
union select 'links', id, 'show_id' from links where show_id not in (select id from shows)
union select 'links', id, 'fandom_id' from links where fandom_id not in (select id from fandoms)
...
union select 'recordings', id, 'video_id' from recordings where video_id not in (select id from videos)
union select 'recordings', id, 'episode_id' from recordings where episode_id not in (select id from episodes)
union select 'recordings', id, 'show_id' from recordings where show_id not in (select id from shows)
union select 'recordings', id, 'movie_id' from recordings where movie_id not in (select id from movies)
union select 'recordings', id, 'language_id' from recordings where language_id not in (select id from languages)
