 ...
 *  $RCSfile$
 *   $Source$
 *     $Date: 2007-07-28 19:00:01 +0200 (Sat, 28 Jul 2007) $
 *   $Author: bananeweizen $
 * $Revision: 3552 $
 */
...
public class IOUtilities
{
	...
	{
		return getStream(page, followRedirects, 60000);
	}
	...
	public static InputStream getStream(URL page)
			throws IOException
	{
		return getStream(page, true, 60000);
	}
	...
	{
		return loadFileFromHttpServer(url, 60000);
	}
